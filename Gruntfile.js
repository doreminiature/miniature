module.exports = function (grunt) {
	...
	grunt.initConfig({
        ...
        watch: {
            scripts: {
                files: ['js/*.js', 'js/**/*.js', 'main/*', 'css/**/*.css', 'index.html'],
	...
	grunt.registerTask('macBuild', ['concat:browser', 'concat:webview', 'concat:main', 'electron:osxBuild'])
	grunt.registerTask('linuxBuild', ['concat:browser', 'concat:webview', 'concat:main', 'electron:linuxBuild', 'electron-installer-debian:linux32', 'electron-installer-debian:linux64'])
	grunt.registerTask('windowsBuild', ['concat:browser', 'concat:webview', 'concat:main', 'electron:windowsBuild'])
};
